...
void main() {
  group('CaptureInboxList Archive Gestures', () {
    testWidgets('displays archive background when swiping item to the right', (
      WidgetTester tester,
    ) async {
      // ARRANGE
    ...
    testWidgets('archives item when swiped far enough to the right', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...
            archiveCaptureItemUseCaseProvider.overrideWithValue(archiveUseCase),
          ],
          child: const MaterialApp(home: Scaffold(body: CaptureInboxList())),
        ),
      );
    ...
    testWidgets('displays success snackbar with undo after archiving', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
    ...
    testWidgets('restores item to inbox when undo is tapped', (
      WidgetTester tester,
    ) async {
      // ARRANGE
    ...
    testWidgets('displays error snackbar when archive fails', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
    ...
    testWidgets('allows archiving multiple items sequentially', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
  ...
  group('CaptureInboxList Delete Gestures', () {
    testWidgets('displays delete background when swiping item to the left', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
    ...
    testWidgets('shows confirmation dialog when swiped far enough to delete', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
    ...
    testWidgets('cancels delete when cancel is tapped in dialog', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
    ...
    testWidgets('deletes item when confirmed in dialog', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
    ...
    testWidgets('displays error snackbar when delete fails', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
    ...
    testWidgets('allows deleting multiple items sequentially', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
  ...
  group('CaptureInboxList Gesture Interactions', () {
    testWidgets('tap on item does not trigger archive or delete', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
      ...
      // ACT
      await tester.tap(find.byKey(CaptureInboxListKeys.itemTile('capture-1')));
      await tester.pumpAndSettle();
    ...
    testWidgets('swipe gestures work after archiving items', (
      WidgetTester tester,
    ) async {
      // ARRANGE
      final repository = _RecordingCaptureRepository()
